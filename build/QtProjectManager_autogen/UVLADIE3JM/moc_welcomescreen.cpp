...
struct qt_meta_stringdata_WelcomeScreen_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WelcomeScreen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WelcomeScreen_t qt_meta_stringdata_WelcomeScreen = {
    {
QT_MOC_LITERAL(0, 0, 13), // "WelcomeScreen"
QT_MOC_LITERAL(1, 14, 18), // "startButtonClicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "WelcomeScreen\0startButtonClicked\0"
};
...
void WelcomeScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WelcomeScreen::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeScreen::startButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WelcomeScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_WelcomeScreen.data,
    qt_meta_data_WelcomeScreen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *WelcomeScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeScreen.stringdata0))
